(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-wecan")) new core(".slider-wecan", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".about-slider")) new core(".about-slider", {
            ...
            if (document.querySelector(".discount-slider")) new core(".discount-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".news-slider")) new core(".news-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        if (script_isMobile.any()) {
            ...
            for (let i = 0; i < arrow.length; i++) {
                ...
                arrow[i].addEventListener("click", (function() {
                    ...
                    thisLink.classList.toggle("parent-active");
                }));
            }
        } else body.classList.add("pc");
        ...
        const weCan = {
            el: document.querySelector(".action-wecan"),
            show() {
                this.el.classList.remove("action-wecan_hide");
            },
            hide() {
                this.el.classList.add("action-wecan_hide");
            },
            addEventListener() {
                window.addEventListener("scroll", (() => {
                    const scrollY = window.scrollY || document.documentElement.scrollTop;
